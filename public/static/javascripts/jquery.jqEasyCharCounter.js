...
$.fn.extend({
    jqEasyCounter: function(givenOptions) {
        return this.each(function() {
			...
			var jqEasyCounterMsg = $("<p class=\"input-count\">&nbsp;</p>");
			...
			$this
				...
				.bind('blur', function(){jqEasyCounterMsg.stop().hide( 'fast', 0);return false;});
			...
			function doCount(){
				...
				jqEasyCounterMsg.html('Caractères : ' + $this.val().length + " sur " + options.maxChars);
